package com.diogosilva.pagamento.controller;
...
import com.diogosilva.pagamento.services.VendaService;
...
public class VendaController {
	...
	public VendaVO create(@RequestBody VendaVO vendaVO) {
		VendaVO vendaCriadaVO = vendaService.create(vendaVO);
		vendaCriadaVO.add(linkTo(methodOn(VendaController.class).findById(vendaCriadaVO.getId())).withSelfRel());
		return vendaCriadaVO;
	}
}
