...
import com.diogosilva.auth.entity.Permission;
import com.diogosilva.auth.entity.User;
import com.diogosilva.auth.repository.PermissionRepository;
import com.diogosilva.auth.repository.UserRepository;
...
public class AuthApplication {
	...
	private void initUsers(UserRepository userRepository, PermissionRepository permissionRepository,
		...
		User find = userRepository.findByUserName("diogosilva");
		if (find == null) {
